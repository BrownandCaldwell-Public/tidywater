...
# tidywater <img src="man/figures/tidywater logo.png" align="right" height = "138" />
...
Tidywater incorporates published water chemistry and empirical models in a standard format with one centralized tool. 
...
The following example employs acid-base chemistry and TOC removal models. This example models a 
...
a dataframe to a list of "waters". After the water has been defined, you can apply other models 
linked together with the pipe operator `%>%` or in separate lines. 
