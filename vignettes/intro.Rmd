...
Now that `water` is balanced, you can see that the potassium concentration was increased. Use the "@" symbol to access a slot in a water class object.
```{r}
water@k
balanced_water@k
```
