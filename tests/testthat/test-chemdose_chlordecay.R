...
test_that("chemdose_chlordecay correctly uses use_chlorine_slot", {
  ...
  expect_warning(water1 %>% chemdose_chlordecay(cl_type = "chlorine", time = 10, cl2_dose = 6, use_chlorine_slot = TRUE), "summed")
  # check that combined chlorine wasn't used in either permutation
  expect_equal(water1@combined_chlorine, water2@combined_chlorine)
  ...
  # check that the correct warning is thrown
  expect_warning(water1 %>% chemdose_chlordecay(cl_type = "chlorine", time = 10, use_chlorine_slot = TRUE), "instead")
  # check that combined chlorine wasn't used in either permutation
  expect_equal(water1@combined_chlorine, water3@combined_chlorine)
  ...
  expect_equal(water4@free_chlorine, water5@free_chlorine)
