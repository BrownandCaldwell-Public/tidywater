...
test_that("chemdose ph works", {
  ...
  expect_equal(round(convert_units(test1@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), 5)
  expect_equal(round(test2@ph, 1), 6.9)
  expect_equal(round(convert_units(test2@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), 85)
  expect_equal(round(test3@ph, 1), 6.4)
  expect_equal(round(convert_units(test3@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), 55)
  expect_equal(round(test4@ph, 1), 6.1)
  expect_equal(round(convert_units(test4@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), 7)
  expect_equal(round(test5@ph, 1), 4.0)
  expect_equal(round(convert_units(test5@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), -5)
  expect_equal(round(test6@ph, 1), 11.4)
  expect_equal(round(convert_units(test6@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), 119)
  expect_equal(round(test7@ph, 1), 6.7)
  expect_equal(round(convert_units(test7@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), 20)
  expect_equal(round(test8@ph, 1), 9.7)
  expect_equal(round(convert_units(test8@carbonate_alk_eq, "caco3", "eq/L", "mg/L"), 0), 26)
})
