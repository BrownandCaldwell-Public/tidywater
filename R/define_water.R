...
#' @param tot_ocl Free chlorine in mg/L as Cl2. Used when a starting water has a free chlorine residual.
#' @param tot_nh2cl Monochloramine in mg/L as Cl2. Used when a starting water has a monochloramine residual.
...
define_water <- function(ph, temp = 25, alk, tot_hard, ca, mg, na, k, cl, so4,
                         tot_ocl = 0, tot_nh2cl = 0, tot_po4 = 0, tot_nh3 = 0, tds, cond,
  ...
  tot_nh2cl <- convert_units(tot_nh2cl, "cl2")
  ...
  water <- methods::new("water",
    ...
    h = h, oh = oh,
    tot_po4 = tot_po4, tot_ocl = tot_ocl, tot_nh2cl = tot_nh2cl, tot_nh3 = tot_nh3, tot_co3 = tot_co3,
...
define_water_chain <- function(df, output_water = "defined_water") {
  define_water_args <- c(
    "ph", "temp", "alk", "tot_hard", "ca", "mg", "na", "k", "cl", "so4", "tot_ocl", "tot_nh2cl", "tot_po4", "tot_nh4",
    "tds", "cond",
    "toc", "doc", "uv254", "br", "f", "fe", "al", "mn"
  )
