...
define_water <- function(ph, temp = 25, alk, tot_hard, ca, mg, na, k, cl, so4,
  ...
  water@nh2cl = combined_chlorine # monochloramine
  water@nhcl2 = combined_chlorine # dichloramine
  water@ncl3 = combined_chlorine # trichloramine
...
define_water_chain <- function(df, output_water = "defined_water") {
  define_water_args <- c(
    "ph", "temp", "alk", "tot_hard", "ca", "mg", "na", "k", "cl", "so4", "free_chlorine", "combined_chlorine", "tot_po4", "tot_nh4",
    "tds", "cond",
    "toc", "doc", "uv254", "br", "f", "fe", "al", "mn"
  )
