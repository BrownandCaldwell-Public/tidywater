...
#' DOC. Coagulated UVA is from the Water Treatment Plant Model. Note that the models rely on pH of coagulation. If pH is 
#' unknown, utilize \code{\link{chemdose_ph}} first. 
#'
